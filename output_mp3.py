...
def out_mp3(array : np.ndarray, filename='mp3.mp3'):
    ...
    # command = ['ffmpeg',
    #            '-i', '-'
    #            '-acodec', 'pcm_f32le', #signed float 32bit litte endian
    #            '-ar', '44100',  # ouput will have 44100 Hz
    #            '-ac', '2',  # stereo (set to '1' for mono)
    #            '-f', 'mp3',
    #            'gg.mp3']
    # pipe = sp.Popen(command, stdout=sp.PIPE, bufsize=44100*4*10)
    ...
    #
    # array = str(array)
    # pipe = sp.Popen(array, stdout=sp.PIPE, stdin=sp.PIPE, bufsize=10 ** 8)
