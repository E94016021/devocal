...
def get_vocal(mix_file, bg_file, lyric_file, out_file="out.wav"):
    ...
    mix, sr_m = librosa.load(mix_file, sr=44100)
    print("mix finish", end='')
    bg, sr_b = librosa.load(bg_file, sr=44100)

    print("...finish resampleing")
...
if __name__ == "__main__":
    get_vocal("/Users/LEE/PycharmProjects/devocal_fac/devocal_test/48336殘酷月光/48336.mp3",
              ...
              "/Users/LEE/PycharmProjects/devocal_fac/devocal_test/48336殘酷月光/ffmpeg.mp3")
